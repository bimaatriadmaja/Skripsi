                            ...
                            <form name="account_edit_form" action="{{ route('admin.settings.update') }}" method="POST"
                                ...
                                <fieldset class="name">
                                    ...
                                    <input class="flex-grow" type="text" placeholder="Alamat Email" name="email"
                                        tabindex="0" value="{{ $admin->email }}" aria-required="true" required="">
                                </fieldset>
                                <div class="col-md-12">
                                    <div class="my-3">
                                ...
                                <fieldset class="name">
                                    ...
                                    <input class="flex-grow" type="password" placeholder="Password lama" id="old_password"
                                        name="old_password" aria-required="true" required="">
                                </fieldset>
                                <fieldset class="name">
                                    <div class="body-title pb-3">Password baru <span class="tf-color-1">*</span>
                                    </div>
                                    <input class="flex-grow" type="password" placeholder="Password baru" id="new_password"
                                        name="new_password" aria-required="true" required="">
                                </fieldset>
                                <fieldset class="name">
                                    <div class="body-title pb-3">Konfirmasi password baru <span class="tf-color-1">*</span>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="my-3">
                                        <button type="submit" class="btn btn-primary tf-button w208">Simpan
                                            Perubahan</button>
                                    </div>
                                </div>
                            </form>
