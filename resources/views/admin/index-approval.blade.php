            ...
            <div class="wg-box">
                @if ($karyawans->isEmpty())
                    <div class="text-center py-5">
                        ...
                        <h4 style="font-size: 1.5rem; font-weight: bold; color: #6c757d;">Tidak ada hasil kerja yang
                            menunggu approval</h4>
                        <p style="font-size: 1.1rem; color: #6c757d;">Semua hasil kerja telah disetujui atau ditolak.</p>
                    </div>
                @else
                    <div class="row">
                                        ...
                                        <div class="d-flex align-items-center mb-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="card-text mb-0" style="font-size: 1.2rem; font-weight: bold;">
                                                    {{ $karyawan->jumlah_pending_approval }}</p>
                                            </div>
                                        </div>
