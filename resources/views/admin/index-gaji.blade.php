                                    ...
                                    <div class="card-body" style="padding: 20px;">
                                        <div class="d-flex align-items-center mb-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="card-text text-muted mb-0" style="font-size: 1.1rem;">Total Gaji
                                                    yang Bisa Diambil:</p>
                                                <p class="card-text mb-0" style="font-size: 1.2rem; font-weight: bold;">Rp
                                                    {{ number_format($karyawan->total_gaji, 0, ',', '.') }}</p>
                                            </div>
                                        </div>
