                ...
                <div class="section-menu-left">
                    ...
                    <div class="center">
                        ...
                        <div class="center-item">
                            <ul class="menu-list">
                                <li class="menu-item">
                                    <a href="{{ route('user.hasil_kerja.add') }}" class="">
                                        <div class="icon"><i class="icon-plus"></i></div>
                                        <div class="text">Tambah Hasil</div>
                                    </a>
                                </li>

                                <li class="menu-item">
                                    <a href="{{ route('user.hasil_kerja') }}" class="">
                                        <div class="icon"><i class="icon-layers"></i></div>
                                        <div class="text">Rekap Hasil</div>
                                    </a>
                                </li>
                                <li class="menu-item">
                                ...
                                <div class="popup-wrap user type-header">
                                    <div class="dropdown">
                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            <span class="header-user wg-user">
                                                ...
                                                <span class="flex flex-column">
                                                    ...
                                                    <span class="text-tiny">Karyawan</span>
                                                </span>
                                            </span>
                                        </button>
                                        <ul class="dropdown-menu dropdown-menu-end has-content"
                                            ...
                                            <li>
                                                <a href="{{ route('user.settings.index') }}" class="user-item">
                                                    <div class="icon">
                                                        <i class="icon-user"></i>
                                                    </div>
